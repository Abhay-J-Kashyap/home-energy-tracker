package com.abhay.ingestion_service.simulation;

import com.abhay.ingestion_service.dto.EnergyUsageDto;
import com.abhay.kafka.event.EnergyUsageEvent;
    ...
    public void sendMockData() {
        for (int i = 0; i <= requestsPerInterval; i++) {
            ...
            try {
                ...
                restTemplate.postForEntity(ingestionEndpoint, entity, String.class);
